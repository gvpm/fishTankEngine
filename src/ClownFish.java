...
public class ClownFish extends LifeForm {
    
    PImage img;
    float imgSize;

    public ClownFish(Tank t,PApplet p, Position pos, float size) {
        super(p,t);
        this.position = pos;
        this.size = size;
        //this.speed = 2;
    ...
    public ClownFish(Tank t,PApplet p, float x, float y, float size) {
        super(p,t);
    ...
    public void display() {
        ...
        if(direction == 1||direction == 2||direction == 3||direction == 4){
            img = p.loadImage("fishR.png");   
            imgD=1;
        }else {
            img = p.loadImage("fishL.png");
            imgD=0;
        }
